...
python3 refactor-pipe.py \
	...
	--breakdown_outputs_path outputs/truthfulqa-rag-google-breakdown-gmeta-llama-Meta-Llama-3-8B-Instruct-Meta-Llama-3-8B-Instruct.out #\
	#--verification_outputs_path outputs/truthfulqa-rag-verifywq-google-gmeta-llama-Meta-Llama-3-8B-Instruct-Meta-Llama-3-8B-Instruct.out
