...
python3 refactor-pipe.py \
        ...
        --breakdown_model_name  meta-llama/Llama-2-7b-chat-hf \
        --verification_model_name  meta-llama/Llama-2-7b-chat-hf \
        --correction_model_name  meta-llama/Llama-2-7b-chat-hf \
	...
	--correct_false_statement_with_question \
        --all_true_not_change \
        --generation_outputs_path outputs/truthfulqa-google-Llama-2-7b-chat-hf.out \
        --breakdown_outputs_path outputs/truthfulqa-google-breakdown-gmeta-llama-Llama-2-7b-chat-hf-Llama-2-7b-chat-hf.out #\

	#--verification_outputs_path outputs/truthfulqa-verifywq-google-gmeta-llama-Llama-2-7b-chat-hf-Llama-2-7b-chat-hf.out
        #--breakdown_outputs_path outputs/
