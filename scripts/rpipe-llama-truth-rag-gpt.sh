...
python3 refactor-pipe.py \
	...
	--correct_false_statement_with_question \
        --all_true_not_change \
	--generation_outputs_path outputs/truthfulqa-rag-google-Llama-2-7b-chat-hf.out \
	--breakdown_outputs_path outputs/truthfulqa-rag-google-breakdown-gmeta-llama-Llama-2-7b-chat-hf-gpt-3.5-turbo.out \
	--verification_outputs_path outputs/truthfulqa-rag-verifywq-google-gmeta-llama-Llama-2-7b-chat-hf-gpt-3.5-turbo-16k-0613.out
