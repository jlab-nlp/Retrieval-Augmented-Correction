...
python3 refactor-pipe.py \
	...
	--breakdown_outputs_path outputs/truthfulqa-google-breakdown-gmeta-llama-Llama-2-7b-chat-hf-gpt-3.5-turbo.out \
	--verification_outputs_path outputs/truthfulqa-verifywq-google-gmeta-llama-Llama-2-7b-chat-hf-gpt-3.5-turbo-16k-0613.out
