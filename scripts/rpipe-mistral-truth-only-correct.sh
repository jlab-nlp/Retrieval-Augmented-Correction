...
python3 refactor-pipe.py \
	...
	--all_true_not_change \
	--generation_outputs_path outputs/truthfulqa-google-Mistral-7B-Instruct-v0.3.out \
	--breakdown_outputs_path outputs/truthfulqa-google-breakdown-gmistralai-Mistral-7B-Instruct-v0.3-Mistral-7B-Instruct-v0.3.out #\
