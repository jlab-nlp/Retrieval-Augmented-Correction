...
python3 refactor-pipe.py \
	...
	--use_rag \
	--only_run_correction \
	--generation_outputs_path outputs/truthfulqa-rag-google-Mistral-7B-Instruct-v0.3.out \
	--breakdown_outputs_path outputs/truthfulqa-rag-google-breakdown-gmistralai-Mistral-7B-Instruct-v0.3-Mistral-7B-Instruct-v0.3.out #\
