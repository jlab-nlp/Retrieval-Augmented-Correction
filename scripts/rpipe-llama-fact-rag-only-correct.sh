...
python3 refactor-pipe.py \
	...
	--correction_length 1024 \
        --only_run_correction \
	--use_rag \
	--generation_outputs_path outputs/factscore-rag-google-Llama-2-7b-chat-hf.out \
	--breakdown_outputs_path outputs/factscore-rag-google-breakdown-gmeta-llama-Llama-2-7b-chat-hf-Llama-2-7b-chat-hf.out \
	--verification_outputs_path outputs/factscore-rag-verifywq-google-gmeta-llama-Llama-2-7b-chat-hf-Llama-2-7b-chat-hf.out
