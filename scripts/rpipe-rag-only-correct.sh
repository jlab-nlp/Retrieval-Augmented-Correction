...
python3 refactor-pipe2.py \
	...
	--verification_length 512 \
        ...
        --use_rag \
	--only_run_correction \
        --generation_outputs_path outputs/factscore-rag-gold-google-gpt-3.5-turbo.out \
        --breakdown_outputs_path outputs/factscore-rag-gold-google-breakdown-ggpt-3.5-turbo-gpt-3.5-turbo.out \
