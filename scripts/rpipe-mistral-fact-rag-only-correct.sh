...
python3 refactor-pipe.py \
        ...
        --breakdown_model_name mistralai/Mistral-7B-Instruct-v0.3 \
        --verification_model_name mistralai/Mistral-7B-Instruct-v0.3 \
        --correction_model_name mistralai/Mistral-7B-Instruct-v0.3 \
	...
	--correction_length 1024 \
        --only_run_correction \
	--use_rag \
	--generation_outputs_path outputs/factscore-rag-google-Mistral-7B-Instruct-v0.3.out \
	--breakdown_outputs_path outputs/factscore-rag-google-breakdown-gmistralai-Mistral-7B-Instruct-v0.3-Mistral-7B-Instruct-v0.3.out #\
	#--verification_outputs_path outputs/factscore-rag-verifywq-google-gmistralai-Mistral-7B-Instruct-v0.3-Mistral-7B-Instruct-v0.3.out
