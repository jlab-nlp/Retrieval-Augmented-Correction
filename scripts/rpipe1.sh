...
python3 refactor-pipe.py \
	...
	--generation_outputs_path outputs/truthfulqa-google-gpt-3.5-turbo.out \
	--breakdown_outputs_path outputs/truthfulqa-google-breakdown-ggpt-3.5-turbo-gpt-3.5-turbo.out \
	--verification_outputs_path outputs/truthfulqa-verifywq-google-ggpt-3.5-turbo-gpt-3.5-turbo-16k-0613.out
	#--verification_outputs_path outputs/truthfulqa-verifywq-google-ggpt-3.5-turbo-gpt-3.5-turbo-16k-0613.out
#mv outputs/truthfulqa-rag-only-correct-wq-gpt-3.5-turbo-1024-gpt-3.5-turbo-0613.out outputs/truthfulqa-rag-only-correct-wq-gpt-3.5-turbo-1024-gpt-3.5-turbo-0613-iter1.out
	#--breakdown_outputs_path outputs/truthfulqa-rag-google-breakdown-ggpt-3.5-turbo-gpt-3.5-turbo.out
        #--verification_outputs_path outputs/truthfulqa-verify-google-ggpt-3.5-turbo-gpt-3.5-turbo-16k-0613.out
        #--use_rag \
