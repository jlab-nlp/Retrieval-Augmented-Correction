...
python3 refactor-pipe.py \
	...
	--correction_length 1024 \
        --only_run_correction \
	--generation_outputs_path outputs/factscore-google-Meta-Llama-3-8B-Instruct.out \
	--breakdown_outputs_path outputs/factscore-google-breakdown-gmeta-llama-Meta-Llama-3-8B-Instruct-gpt-3.5-turbo.out #\
